...
EXTRACTORS = {
    "partidos": AsyncPartidosExtractor,
    "ids": AsyncPartidosIdsExtractor,
    "lideres": AsyncLideresExtractor,
    "membros": AsyncPartidosMembrosExtractor,
}

DEPENDENCIES = {
    "ids":     {"partidos": "partidos"},
    "lideres": {"partidos": "partidos"},
    "membros": {"partidos": "partidos"},
}
